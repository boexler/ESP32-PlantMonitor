/**
 * @file pm_mqtt.h
 * @brief MQTT client: Home Assistant discovery, soil raw ADC state topics, retained metadata.
 */
 ...
 * @param moisture_pct Per channel: averaged raw ADC when valid, or -1 when disconnected/invalid
 *                    (see Kconfig PM_SOIL_ADC_DISCONNECT_MAX / PM_SOIL_ADC_SPIKE_MIN); ignored if channel inactive.
 */
